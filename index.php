    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-primary ">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                <a href="index.php" class="nav-item nav-link active">Remote Control</a>
...
<div class="container">
    ...
    <form>
        <div class="form-row">
            ...
            <div class="col">
                <input type="text" class="form-control input-sm" id="email" placeholder="Input Destination IP Address and choose remote command" name="email">
            </div>
            <div class="col">
